...
- [[#core-settings][core settings]]
  ...
  - [[#appearance][appearance]]
    - [[#fonts][fonts]]
    - [[#themes-icons--extras][themes, icons & extras]]
    - [[#dashboard][dashboard]]
    - [[#modeline][modeline]]
    - [[#tooltips][tooltips]]
- [[#dired][dired]]
...
(use-external-package! evil-surround
  ...
  | [[https://github.com/edkolev/evil-goggles/][evil-goggles]] | visual hints for vi operations |

#+begin_src emacs-lisp
(use-external-package! evil-goggles
  :after evil
  :defer 2
  :config
  (setq evil-goggles-pulse nil)
  (setq evil-goggles-pulse 'display-graphic-p)
  (setq evil-goggles-lighter nil)
...
| [[https://github.com/iyefrat/all-the-icons-completion][all-the-icons-completion]] | icons for completion candidates |

#+begin_src emacs-lisp
(after-gui!
  (use-external-package! all-the-icons-completion
    :after all-the-icons
    :defer 2
    :config
...
common settings for both ~C~ and ~C++~; the latter should inherit from the
former.
...
(use-builtin-package! cc-mode
  ...
  (add-hook! '(c-mode-hook c++-mode-hook) (list #'eglot-ensure
                                                #'company-mode)))
  #+end_src
...
#+begin_src emacs-lisp
(use-external-package! nim-mode
  :mode "\\.nim\\'"
  :config
  (require 'eglot)
  (add-hook! 'nim-mode-hook (list #'eglot-ensure
                                  #'company-mode))
